    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 125, storeType: "nvarchar"),
            ...
            CreateTable(
                ...
                c => new
                    {
                        UserId = c.String(nullable: false, maxLength: 125, storeType: "nvarchar"),
                        RoleId = c.String(nullable: false, maxLength: 125, storeType: "nvarchar"),
                    })
            ...
            CreateTable(
                ...
                c => new
                    {
                        LoginProvider = c.String(nullable: false, maxLength: 125, storeType: "nvarchar"),
                        ProviderKey = c.String(nullable: false, maxLength: 125, storeType: "nvarchar"),
                        UserId = c.String(nullable: false, maxLength: 125, storeType: "nvarchar"),
                    })
